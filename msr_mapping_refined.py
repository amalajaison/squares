...
#labels=[r"\underline{Free space}"]+l[0:3]+[r"\underline{Target} $(\ell,m)=(%d,%d)$"%(graphdata['l'],graphdata['m'])]+l[3:6]+[r"\underline{Image current effects}"]+l[6:9]+[r"\underline{COMSOL}"]+l[9:12]
...
handles=[ph[0]]+h[0:3]+[ph[1]]+h[3:6]+[ph[2]]+h[6:9]+[ph[3]]+h[9:12]
labels=[r'\underline{Measured}']+l[0:3]+[r"\underline{Simulated: In free space}"]+l[3:6]+[r"\underline{Image current effects: $\approx$ a factor of 2}"]+l[6:9]+[r"\underline{COMSOL}"]+l[9:12]
...
plt.savefig("map_my_shims_coil4_models.png",dpi=300)
